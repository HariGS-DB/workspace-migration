-- Query 1: UC vs Non-UC dollar split (overall) for UK South FY26 Q4
SELECT
  ...
  ROUND(SUM(workload_insights_metric.uc_dollars) / NULLIF(SUM(usage_dollars), 0) * 100, 2) AS uc_pct_all,
